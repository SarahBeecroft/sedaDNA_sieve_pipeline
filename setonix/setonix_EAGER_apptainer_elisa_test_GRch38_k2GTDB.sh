#!/bin/bash -l
#SBATCH --job-name=EAGER_apptainer_IODP_test
...
cd $MYSCRATCH/chapter2_data/Elisa_Prashasti_shotgun_Antarctica_reanalysis_2025/eager_humanref_kraken2gtdb
...
-r 2.5.3 \
-profile singularity \
-c $MYSCRATCH/scripts_chapter2/IMAS_Nextflow_2025.config \
-w ./work/ \
--input ${MYSCRATCH}/chapter2_data/Elisa_Prashasti_shotgun_Antarctica_reanalysis_2025/20210706_Exp382_Deep_demux_noncollapsed/*.pair{1,2}.fastq \
...
--clip_adapters_list ${MYSCRATCH}/chapter2_data/Elisa_Prashasti_shotgun_Antarctica_reanalysis_2025/20210706_Exp382_Deep_demux_noncollapsed/adapter_list.txt \
--trimns \
--trimqualities \
--collapse \
--dedupper dedup \
...
--database ${MYSCRATCH}/Databases/GTDBr226_k2_ncbitaxonomy/ \
